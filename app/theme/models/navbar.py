...
class Navbar(models.Model):
    ...
    navbar_background_active = models.BooleanField(
        default=False,
        verbose_name=('Active'),
    )
    ...
    navbar_panels = (
        ...
        MultiFieldPanel(
            (
                FieldRowPanel(
                    ...
                    heading='Das ist ein heading',
                    help_text='Das ist ein help text',
                ),
            ),
            heading='Basics',
        ...
        MultiFieldPanel(
            (
                FieldRowPanel(
                    children=(
                        FieldPanel('navbar_background_active',
                                   classname="col6"),
                        NativeColorPanel(
                            'navbar_background_color', classname="col12"),
                    )
                ),
            ),
            heading='Background',

...
def get_config(request):
    return JsonResponse(data={"publishableKey": os.getenv('STRIPE_PUBLISHABLE_KEY')},)
...
def create_customer(request):
    ...
    try:
        ...
        return JsonResponse(data={'customer': customer})
    except Exception as e:
        return JsonResponse(data={"error": e}, status=403 )
